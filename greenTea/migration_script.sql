...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20240124223911_InitialCreate')
BEGIN
...
BEGIN
    CREATE TABLE [Receitas] (
        ...
        [DescricaoTopo] nvarchar(max) NOT NULL,
        [Descricao] nvarchar(max) NOT NULL,
        [Ingredientes] nvarchar(max) NOT NULL,
        [ModoPreparo] nvarchar(max) NOT NULL,
        [NumPorcoes] int NOT NULL,
        [Calorias] int NOT NULL,
        [TempoPreparo] nvarchar(max) NULL,
...
BEGIN
    ...
    VALUES (N'20240124223911_InitialCreate', N'5.0.14');
END;
GO
